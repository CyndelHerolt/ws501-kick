    ...
    <div class="panel" style="display: flex; justify-content: center">
      <div class="card" style="width: 60%">
        <p style="text-align: center">
          Nous avons conçu une interface de visualisation de modèles 3D pour mettre en avant les valeurs fortes de vos
          produits. L'outil est pluriel et s'adapte à vos besoins. Vous pouvez l'utiliser comme un outil de vente, de
          formation ou de recherche. Les deux options principales sont le visualisateur vitrine et le configurateur. Le
          visualisateur vitrine permet de mettre en avant les détails de vos produits et de les annoter. Le
          configurateur permet de personnaliser les produits en temps réel.
        </p>
      </div>
    </div>
    ...
    <div class="panel">
      <div class="card" style="width: 50%">
        ...
        <p>Notre plateforme offre une expérience immersive où vous pouvez importer facilement vos propres modèles 3D et
          ...
          complexe et ajouter des annotations directement sur chaque élément structurel, ou annoter des caractéristiques
          sur un prototype de produit en développement. Notre viewer 3D offre une interface intuitive qui permet à
